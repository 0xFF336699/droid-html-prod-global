"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[9538],{
...
// UNUSED EXPORTS: ActionContext, ActionGroupContext, ActionListContext, ActionListFromEnum, ActionUtilsMap, CreateProjectButton, EditProjectBuilder, GroupCheckList1Context, GroupCheckList2Context, PROJECT_CATEGORY_CONFIGS, ProjectCategory, ProjectContext, ProjectMemberType, ProjectUI, ProjectsUI, RemoteSyncStatus, SCRIPT_ACTION_TYPE, TriggerActionContext, TriggerActionGroupContext, TriggerContext, TriggerGroupContext, TriggerListContext, TriggerOrActionListTypeEnum, TriggerUtilsMap, actionGroupType, actionGroupUtils, adaptV1ToV2, addProjectHistory, childToProjectDataUtils, createActionHandler, createActionUtils, createDefaultAction, createDefaultActionGroup, createDefaultProject, createDefaultProjectSettings, createDefaultScriptAction, createDefaultTrigger, createDefaultTriggerAction, createDefaultTriggerActionGroup, createDefaultTriggerGroup, createMergeToDefaultData, createProjectByCategory, createProjectEditInfo, createTriggerActionUtils, createTriggerHandler, createTriggerUtils, editProjectInfoUtils, getActionGroupByProp, getActionGroupElement, getActionGroupElementByProp, getActionListByProp, getActionUtils, getProjectCategoryConfig, getProjectHistory, getProjectLastHistory, getTriggerByProp, getTriggerElementByProp, getTriggerListByProp, getTriggerListElementByProp, getTriggerOrActionListPageParams, getTriggerUtils, isSameProjectHistoryId, mergeDataWith, mergeToDefaultData, mergeTriggerActionGroupToDefaultData, projectDataToUniqueId, projectEventUtils, projectHistoryIsChanged, projectNamespace, projectStore, projectUtils, projectsHistoryMap, registerActionUtils, registerTriggerUtils, removeProjectHistory, s, saveToServer, syncToServer, takeProjectSnapshoot, triggerActionGroupType, triggerGroupType, triggerGroupUtils, updateToServer
...
fileLog.pause = true;
class ProjectListSyncManager extends EventDispatcher/* EventDispatcher */.Q {
    ...
    getProjectsFromStorage() {
        ...
        try {
            const projects = src/* projectStore */.DO.getListCopy();
...
function onUserSignout() {
    projectManager_fileLog.log('onUserSignout');
    src/* projectStore */.DO.cleanStorage();
    projectManager_fileLog.log('onUserSignout2');
}
...
//# sourceMappingURL=9538.fc41932f0d7d3b27.js.map