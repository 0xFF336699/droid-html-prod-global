(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[1879],{
...
;// ./src/components/i18n-examples/button/ExampleButton.tsx
// useTranslation 导入规则，使用 @fanfanlo 库里的 useTranslation


// 命名规则，每个组件都跟随一个与自己同名的 i18n.json 文件，例如这个是 ExampleButton.json
function ExampleButton() {
    // 命名空间规则
    // homepage 是当前项目的名称
    // components/i18n-exmaples/button/ 是从项目名称 homepage开始，到当前目录的路径去掉了src
    // content是固定字段。
    const { t } = (0,es/* useTranslation */.Bd)('homepage/components/i18n-exmaples/button/content');
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
            children: t('ExampleButton.name')
        })
    });
}

// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_react@19.1.0__@emotion+styled_7n6ip7adzgskiknwagt7k5dnla/node_modules/@mui/material/Autocomplete/Autocomplete.js + 3 modules
var Autocomplete = __webpack_require__(83316);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_react@19.1.0__@emotion+styled_7n6ip7adzgskiknwagt7k5dnla/node_modules/@mui/material/ListSubheader/ListSubheader.js + 1 modules
var ListSubheader = __webpack_require__(87295);
...
;// ./src/components/permissions/android-permissions/AndroidPermissionsSelector.tsx
...
/**
 * 权限选择器组件
 * @param props.permissions 初始选中的权限值数组
 */ const AndroidPermissionsSelector = (param)=>{
    let { permissions } = param;
    const { t } = (0,es/* useTranslation */.Bd)('droid-android/android/components/content');
    // 1. 构造用于 Autocomplete 的完整选项列表 (options)
    const permissionOptions = (0,react.useMemo)(()=>{
        const options = [];
        // 1.1. 处理 ManifestPermissionGroup
        Object.keys(Manifest/* ManifestPermissionGroup */.Kt).forEach((key)=>{
            options.push({
                key: key,
        ...
        Object.keys(Manifest/* ManifestPermission */.Ls).forEach((key)=>{
            options.push({
                key: key,
    ...
    // 2. 构造查询 Map (用于高效查找已选中的选项对象)
    const valueToOptionMap = (0,react.useMemo)(()=>{
        const map = new Map();
    ...
    // 3. 将传入的已选权限值数组 (permissions) 转换为 Autocomplete 需要的选项对象数组 (initialValue)
    const initialValue = (0,react.useMemo)(()=>{
        // 过滤掉那些在 Map 中找不到对应选项的无效权限值
        return permissions.map((p)=>valueToOptionMap.get(p)).filter((option)=>option !== undefined);
    }, [
        permissions,
        valueToOptionMap
    ]);
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(Autocomplete/* default */.A, {
        multiple: true,
        // 设置 Autocomplete 的初始值
        // 注意：使用 defaultValue 使组件成为**非受控组件**，如果你希望在父组件中实时管理选择状态，
        // 应该使用 value 属性并结合外部状态管理（如 useState）。
        defaultValue: initialValue,
        // 选项来源
        options: permissionOptions,
        // 如何从 option 获取分组键
        groupBy: (option)=>option.group,
        // 如何从 option 获取显示标签 (这是 Autocomplete 默认用于过滤和显示的属性)
        getOptionLabel: (option)=>option.label,
        // **移除 onChange 逻辑，如你所要求**
        // onChange={(event, newValue) => { /* 外部逻辑处理 */ }}
        renderInput: (params)=>/*#__PURE__*/ (0,jsx_runtime.jsx)(TextField/* default */.A, {
                ...params,
                label: t('PermissionsSelector.Label', '选择 Android 权限'),
                placeholder: t('PermissionsSelector.Placeholder', '搜索权限')
            }),
        renderGroup: (params)=>/*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(ListSubheader/* default */.A, {
                        component: "div",
                        sx: {
                            p: 1,
                        ...
                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.A, {
                            variant: "subtitle2",
                            color: "primary",
                            children: t("PermissionsSelector.Group.".concat(params.group), params.group === 'ManifestPermissionGroup' ? '权限组 (ManifestPermission Groups)' : '权限 (Permissions)')
                        })
                    }),
                    params.children
                ]
            }, params.key),
        // *** 核心修改点：renderTags 使用 option.label (国际化说明) ***
        // *** 修复后的 renderTags 部分 ***
        renderTags: (value, getTagProps)=>value.map((option, index)=>{
                // 提取 getTagProps 返回的所有属性
                const tagProps = getTagProps({
                    index
                });
                // 从 tagProps 中解构出 key，其余属性保存到 restProps
...
;// ./src/components/permissions/android-permissions/TestAndroidPermissionsButton.tsx



function TestAndroidePermissionsButton() {
    const data = (0,proxyWatch/* toProxy */.I$)({
        permissions: []
    });
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(AndroidPermissionsButton/* AndroidPermissionsButton */.S, {
        permissionsProps: data
    });
}
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box_Box/* default */.A, {
            children: [
                ...
                /*#__PURE__*/ (0,jsx_runtime.jsx)(AndroidPermissionsSelector, {
                    permissions: []
                }),
                /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(ExampleButton, {}),
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(TestAndroidePermissionsButton, {})
                    ]
                })
            ]
        })
...
//# sourceMappingURL=1879-7231ab85411c893a.js.map