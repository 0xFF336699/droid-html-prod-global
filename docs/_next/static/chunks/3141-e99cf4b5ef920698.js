(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[3141],{
...
function useTabActivity() {
    ...
    (0,react.useEffect)(()=>{
        return tab_activity/* tabActivity */.T.listen((bl)=>{
            setIsActive(bl);
        });
    }, []);
    return isActive;
...
;// ./src/components/permissions/notification/NotificationOpenButton.tsx
...
function NotificationOpenButton() {
    const uiLog = new Log/* Log */.tG(false, 'NotificationOpenButton_ui');
    const { t } = (0,dist_es/* useTranslation */.Bd)('homepage/components/permissions/notification/content');
    function onClick() {
        const permissions = JSON.stringify([
            Manifest/* Manifest */._.Permission.POST_NOTIFICATIONS
        ]);
        console.log('permissions = ', permissions);
        const script = "\n        com.fanfanlo.lib.permission.PermissionRequestManager.requestMultiplePermissions(".concat(permissions, ")\n        ");
        AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
    ...
    function readNotifications() {
        const script = "\n            var s = com.fanfanlo.lib.notification.NotificationReader.readActivePayloads();\n            s;\n            ";
        console.log('call opensettings');
        const { javaResultString, errMsg } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
        console.log('javaResultString = ', javaResultString, 'errMsg = ', errMsg);
    }
    function askingPermissions() {
        const eventType = (0,index_esm/* ulid */.Z0)(); // "a11yNodeSelectActionItem";
        uiLog.info('askingPermissions_fn eventType=', eventType);
        const res = permissionUtils/* permissionUtils */.f.askPermissions([
            Manifest/* Manifest */._.Permission.BIND_NOTIFICATION_LISTENER_SERVICE
        ], eventType, onAskPermissionComplete);
        uiLog.info('askingPermissions_fn res=', res);
        if (res.isGranted) {
            onAskPermissionComplete(false, true);
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box_Box/* default */.A, {
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
                        onClick: askingPermissions,
                        children: t('NotificationOpenButton.name')
                    }),
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.A, {
                        children: t('NotificationOpenButton.description')
                    })
                ]
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
...
function ScaneQRCodeButton() {
    const { t } = (0,dist_es/* useTranslation */.Bd)('homepage/components/notification-listener/content');
    function onClick() {
...
function SettingPanel(props) {
    ...
    function checkUpdateSetting() {
        uiLog.info('checkUpdateSetting_fn');
        if (portError) {
        ...
        uiLog.info('Calling updateSettingBase64 with script:', script);
    ...
    (0,react.useEffect)(()=>{
        uiLog.info('useEffect_fn, open changed:', open);
        if (open) {
    ...
    const handlePortChange = (event)=>{
        ...
        if (value === '') {
            setPortInput('');
            setPortError(t('SettingPanel.portRequired'));
            return;
        }
        setPortInput(value);
...
function NotificationReadable() {
    ...
    function refresh() {
        ...
        fnLog.info('Checking if notification listener service is connected and readable');
        const script = "\n        com.fanfanlo.lib.notification.MyNotificationListenerService.readIsConnected()\n    ";
        const { javaResultData, javaResultString, errMsg } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
        fnLog.info("Script result: javaResultData=".concat(javaResultData, ", javaResultString=").concat(javaResultString, ", errMsg=").concat(errMsg));
        if (errMsg) {
            setReadable(false);
            return;
        }
    ...
    (0,react.useEffect)(()=>{
        ...
        function onConnected() {
            setReadable(true);
            effLog.info('onConnected_event');
        }
        function onDisconnected() {
            setReadable(false);
            effLog.info('onDisconnected_event');
        }
        effLog.info('Setting up event listeners for notification listener service connection status');
        ...
        return ()=>{
            ...
            effLog.info('Cleaned up event listeners for notification listener service connection status');
        };
    }, []);
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
...
function SocketServerSwitch() {
    ...
    function refresh() {
        const fnLog = uiLog.sub(false, '    refresh_fn');
        fnLog.info('Checking if socket server is running');
        const script = "\n      com.fanfanlo.lib.notification.NotificationSocketServer.serverIsRunning()\n    ";
        const { javaResultData, javaResultString, errMsg } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
        fnLog.info("NotificationSocketServer.serverIsRunning Script result: javaResultData=".concat(javaResultData, ", javaResultString=").concat(javaResultString, ", errMsg=").concat(errMsg));
        if (errMsg) {
            setIsRunning(false);
            return;
        }
    ...
    function handleStart() {
        ...
        fnLog.info('Starting socket server');
        ...
        fnLog.info('Server start request sent');
    }
    function handleStop() {
        const fnLog = uiLog.sub(false, '    handleStop_fn');
        fnLog.info('Stopping socket server');
    ...
    (0,react.useEffect)(()=>{
        ...
        function onSwitched(event) {
            ...
            effLog.info('notificationSocketServerSwitched Socket server switched:', isOn);
            setIsRunning(isOn);
        }
        function onSwitchOn() {
            effLog.info('notificationSocketServerSwitched Socket server switched on');
            setIsRunning(true);
        }
        function onSwitchOff() {
            effLog.info('notificationSocketServerSwitched Socket server switched off');
            setIsRunning(false);
        }
        effLog.info('Setting up event listeners for socket server status');
        ...
        return ()=>{
            ...
            effLog.info('Cleaned up event listeners for socket server status');
        };
    }, []);
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
...
function NotificationListenerPanel() {
    ...
    function refreshServerStatus() {
        ...
        uiLog.info('getStatus result:', javaResultString);
    ...
    const handleSwitchChange = (event)=>{
        uiLog.info('handleSwitchChange_fn, checked:', event.target.checked);
        ...
        try {
            if (checked) {
                ...
                const notificationContent = t('NotificationListenerPanel.foregroundService.content');
                const requestReason = t('NotificationListenerPanel.foregroundService.reason');
                uiLog.info('Starting notification listener with foreground service:', {
                    notificationTitle,
                    notificationContent,
                    requestReason
                });
                ...
                uiLog.info('Foreground service request sent, waiting for user authorization');
                // 可选: 监听前台服务授权结果
                const eventName = 'notification_socket_server_foreground_event';
                const handleForegroundEvent = (event)=>{
                    const customEvent = event;
                    const data = customEvent.detail;
                    uiLog.info('Foreground service event:', data);
                    if (data.status === 'SUCCESS') {
                        uiLog.info('Foreground service authorized, server started');
                        refreshServerStatus();
    ...
    const handleOpenSettingPanel = ()=>{
        uiLog.info('handleOpenSettingPanel_fn');
        setIsSettingPanelOpen(true);
    };
    const handleCloseSettingPanel = ()=>{
        uiLog.info('handleCloseSettingPanel_fn');
        setIsSettingPanelOpen(false);
    };
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Stack/* default */.A, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Stack/* default */.A, {
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(NotificationReadable, {}),
...
function HomePagePermissions() {
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box_Box/* default */.A, {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(NotificationOpenButton, {}),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(NotificationListenerPanel, {})
        ]
    });
}
...
;// ./src/components/mobile-album/MobileAlbumSettingPanel.tsx
...
const MobileAlbumSettingPanel_fileLog = new Log/* Log */.tG(false, "MobileAlbumSettingPanel_file");
function MobileAlbumSettingPanel(props) {
    const uiLog = MobileAlbumSettingPanel_fileLog.sub(false, "  MobileAlbumSettingPanel_ui");
    const { t } = (0,dist_es/* useTranslation */.Bd)('homepage/components/mobile-album/content');
    const { open, onClose } = props;
    const [initialSetting, setInitialSetting] = (0,react.useState)({
        port: 8080,
        token: ''
    });
    const [portInput, setPortInput] = (0,react.useState)(String(initialSetting.port));
    const [tokenInput, setTokenInput] = (0,react.useState)(initialSetting.token);
    const [portError, setPortError] = (0,react.useState)('');
    const [permissionType, setPermissionType] = (0,react.useState)('contentresolver');
    const [permissionStatus, setPermissionStatus] = (0,react.useState)({
    ...
    function checkUpdateSetting() {
        ...
        if (currentSetting.port === initialSetting.port && currentSetting.token === initialSetting.token) {
            uiLog.info('Settings have not changed, skipping update.');
            return;
        }
        const settingBase64 = store/* autoJsStoreUtils */.b.btoaUtf8(JSON.stringify(currentSetting));
        const script = "\n    com.fanfanlo.lib.mediaservice.MediaService.updateSettingBase64('".concat(settingBase64, "');\n    ");
        uiLog.info('Calling updateSettingBase64 with script:', script);
        const { errMsg } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
        if (errMsg) {
            uiLog.error('updateSettingBase64 error:', errMsg);
            showMessage('设置更新失败: ' + errMsg, 'error');
        } else {
            showMessage('设置已更新', 'success');
        }
    }
    const loadServiceSetting = ()=>{
        uiLog.info('loadServiceSetting_fn');
        const script = "\n    var s = com.fanfanlo.lib.mediaservice.MediaService.loadSettingBase64();\n    s;";
        const { javaResultString, errMsg } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
        if (errMsg) {
            uiLog.error('loadSettingBase64 error:', errMsg);
            return;
        }
        const str = store/* autoJsStoreUtils */.b.atobUtf8(javaResultString || '');
        if (!str) {
            uiLog.error('atobUtf8 result empty, javaResultString=', javaResultString);
            return;
        }
        const storedSetting = JSON.parse(str || '{}');
        setInitialSetting(storedSetting);
        setPortInput(String(storedSetting.port));
        setTokenInput(storedSetting.token);
        setPortError('');
    };
    const checkPermissions = ()=>{
        uiLog.info('checkPermissions_fn');
        const script = "\n    var permissions = com.fanfanlo.lib.mediaservice.MediaService.checkPermissions();\n    permissions;";
        const { javaResultString, errMsg } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
        if (errMsg) {
            uiLog.error('checkPermissions error:', errMsg);
            return;
        }
        if (javaResultString) {
            try {
                const permissions = JSON.parse(javaResultString);
                uiLog.info('checkPermissions result:', permissions);
                setPermissionStatus(permissions);
            } catch (e) {
                uiLog.error('Parse permissions error:', e);
            }
        }
    };
    const requestPermissions = ()=>{
        uiLog.info('requestPermissions_fn');
        setLoading(true);
        const script = "\n    var permissions = com.fanfanlo.lib.mediaservice.MediaService.requestContentResolverPermission();\n    permissions;";
        const { javaResultString, errMsg } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
        if (errMsg) {
            uiLog.error('requestPermissions error:', errMsg);
            showMessage('申请权限失败: ' + errMsg, 'error');
        } else {
            showMessage('请在系统对话框中授予权限', 'info');
            setTimeout(()=>{
                checkPermissions();
            }, 2000);
        }
    ...
    const setPermissionTypeHandler = (type)=>{
        uiLog.info('setPermissionType_fn:', type);
        const script = '\n    var result = com.fanfanlo.lib.mediaservice.MediaService.setPermissionType("'.concat(type, '");\n    result;');
        const { javaResultString, errMsg } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
        if (errMsg) {
            uiLog.error('setPermissionType error:', errMsg);
            showMessage('设置权限模式失败: ' + errMsg, 'error');
            return;
        }
        const success = javaResultString === 'true';
        if (success) {
            setPermissionType(type);
            showMessage('权限模式已更新', 'success');
        } else {
            showMessage('设置权限模式失败', 'error');
        }
    };
    ...
    const validatePort = (port)=>{
        ...
        if (isNaN(portNum) || portNum < 1 || portNum > 65535) {
            setPortError('端口必须是1-65535之间的数字');
        } else {
            setPortError('');
        }
    };
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Dialog/* default */.A, {
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)(DialogTitle/* default */.A, {
                children: t('MobileAlbumSettingPanel.title')
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(DialogContent/* default */.A, {
                children: [
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box_Box/* default */.A, {
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.A, {
                                        variant: "subtitle1",
                                        gutterBottom: true,
                                        children: t('MobileAlbumSettingPanel.serviceConfig')
                                    }),
                                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(Stack/* default */.A, {
                                        spacing: 2,
                                        children: [
                                            /*#__PURE__*/ (0,jsx_runtime.jsx)(TextField/* default */.A, {
                                                label: t('MobileAlbumSettingPanel.port'),
                                                value: portInput,
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime.jsx)(TextField/* default */.A, {
                                                label: t('MobileAlbumSettingPanel.token'),
                                                value: tokenInput,
                                                onChange: (e)=>setTokenInput(e.target.value),
                                                size: "small",
                                                disabled: true,
                                                helperText: t('MobileAlbumSettingPanel.tokenHelp')
                                            })
                                        ]
                                    })
                                ]
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box_Box/* default */.A, {
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.A, {
                                        variant: "subtitle1",
                                        gutterBottom: true,
                                        children: t('MobileAlbumSettingPanel.permissionConfig')
                                    }),
                                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(Stack/* default */.A, {
                                        spacing: 2,
                                        children: [
                                            /*#__PURE__*/ (0,jsx_runtime.jsxs)(FormControl/* default */.A, {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(InputLabel/* default */.A, {
                                                        children: t('MobileAlbumSettingPanel.permissionType')
                                                    }),
                                                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(Select/* default */.A, {
                                                        value: permissionType,
                                                        onChange: (e)=>setPermissionTypeHandler(e.target.value),
                                                        disabled: loading,
                                                        children: [
                                                            /*#__PURE__*/ (0,jsx_runtime.jsx)(MenuItem/* default */.A, {
                                                                value: "contentresolver",
                                                                children: t('MobileAlbumSettingPanel.contentResolver')
                                                            }),
                                                            /*#__PURE__*/ (0,jsx_runtime.jsx)(MenuItem/* default */.A, {
                                                                value: "saf",
                                                                children: t('MobileAlbumSettingPanel.saf')
                                                            })
                                                        ]
                                                    })
                                                ]
                                                    ...
                                                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(Stack/* default */.A, {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.A, {
                                                                variant: "body2",
                                                                children: [
                                                                    t('MobileAlbumSettingPanel.permissionStatus'),
                                                                    ":"
                                                                ]
                                                            }),
                                                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Chip/* default */.A, {
                                                                label: permissionStatus.contentResolver ? t('MobileAlbumSettingPanel.permissionGranted') : t('MobileAlbumSettingPanel.permissionDenied'),
                                                                color: permissionStatus.contentResolver ? 'success' : 'error',
                                                                size: "small"
                                                            }),
                                                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
                                                                size: "small",
                                                                ...
                                                                disabled: loading,
                                                                children: t('MobileAlbumSettingPanel.refresh')
                                                            })
                                                        ]
                                                    }),
                                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
                                                        ...
                                                        disabled: loading || permissionStatus.contentResolver,
                                                        children: t('MobileAlbumSettingPanel.requestPermissions')
                                                    })
                                                ]
                                            })
                                        ]
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(DialogActions/* default */.A, {
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
                        onClick: onClose,
                        children: t('MobileAlbumSettingPanel.cancel')
                    }),
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
                        onClick: checkUpdateSetting,
                        variant: "contained",
                        disabled: !!portError,
                        children: t('MobileAlbumSettingPanel.save')
                    })
                ]
            })
        ]
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/PhotoLibrary.js
var PhotoLibrary = __webpack_require__(80471);
;// ./src/components/mobile-album/MobileAlbumPanel.tsx
...
const MobileAlbumPanel_fileLog = new Log/* Log */.tG(false, 'MobileAlbumPanel_file');
function MobileAlbumPanel() {
    const uiLog = MobileAlbumPanel_fileLog.sub(false, '  MobileAlbumPanel_ui');
    const { t } = (0,dist_es/* useTranslation */.Bd)('homepage/components/mobile-album/content');
    // 控制开关状态
    const [isServiceEnabled, setIsServiceEnabled] = (0,react.useState)(false);
    // 控制设置弹窗的显示和隐藏
    const [isSettingPanelOpen, setIsSettingPanelOpen] = (0,react.useState)(false);
    const [serviceStatus, setServiceStatus] = (0,react.useState)({
        isRunning: false,
        port: 8080,
        token: '',
        serverUrl: ''
    ...
    function refreshServiceStatus() {
        uiLog.info('refreshServiceStatus_fn');
        const script = "\n    var status = com.fanfanlo.lib.mediaservice.MediaService.getServiceStatus();\n    status;";
        const { javaResultString, errMsg } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
        if (errMsg) {
            uiLog.error('getServiceStatus error:', errMsg);
            return;
        }
        uiLog.info('getServiceStatus result:', javaResultString);
        if (javaResultString) {
            try {
                const status = JSON.parse(javaResultString);
                setServiceStatus(status);
                setIsServiceEnabled(status.isRunning);
            } catch (e) {
                uiLog.error('Parse service status error:', e);
            }
        }
    }
    (0,react.useEffect)(()=>{
        uiLog.info('useEffect - component mounted');
    ...
    const handleSwitchChange = (event)=>{
        ...
        const checked = event.target.checked;
        if (checked) {
            const script = "\n        var result = com.fanfanlo.lib.mediaservice.MediaService.startService();\n        result;";
            const { javaResultString, errMsg } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
            if (errMsg) {
                uiLog.error('startService error:', errMsg);
                return;
            }
            const success = javaResultString === 'true';
            if (success) {
            ...
            const script = "\n        com.fanfanlo.lib.mediaservice.MediaService.stopService();\n        true;";
            AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
            setIsSettingPanelOpen(false);
            refreshServiceStatus();
        }
    ...
    const handleOpenAlbum = ()=>{
        uiLog.info('handleOpenAlbum_fn');
        if (serviceStatus.serverUrl && serviceStatus.token) {
            const albumUrl = "".concat(serviceStatus.serverUrl, "/mobile-album?token=").concat(serviceStatus.token);
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Stack/* default */.A, {
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.A, {
                ...
                children: t('MobileAlbumPanel.title')
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Switch/* default */.A, {
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Chip/* default */.A, {
                label: serviceStatus.isRunning ? t('MobileAlbumPanel.running') : t('MobileAlbumPanel.stopped'),
                color: serviceStatus.isRunning ? 'success' : 'default',
                size: "small"
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.A, {
                variant: "body2",
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
                variant: "outlined",
                onClick: handleOpenSettingPanel,
                children: t('MobileAlbumPanel.settingsButtonLabel')
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
                variant: "contained",
                startIcon: /*#__PURE__*/ (0,jsx_runtime.jsx)(PhotoLibrary/* default */.A, {}),
                onClick: handleOpenAlbum,
                disabled: !serviceStatus.isRunning,
                size: "small",
                children: t('MobileAlbumPanel.openAlbum')
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(MobileAlbumSettingPanel, {
                open: isSettingPanelOpen,
                onClose: handleCloseSettingPanel
            })
        ]
...
;// ./src/components/qiyeweixin/testbutton.tsx




const testbutton_fileLog = new Log/* Log */.tG(false, "homepage/components/qiyeweixin/testbutton");
function QiyeWeixinTestButton() {
    const uiLog = testbutton_fileLog.sub(false, "  QiyeWeixinTestButton_ui");
    async function openApp() {
        const script = '\n        com.fanfanlo.lib.intent.IntentFuncs.openApp("com.tencent.wework")';
        AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
    }
    async function onClick() {
        openApp();
...
function AndroidFloatWindowLink() {
...
function Content() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box_Box/* default */.A, {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(QiyeWeixinTestButton, {}),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(MobileAlbumPanel, {}),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(TestA11y, {}),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(AndroidFloatWindowLink, {}),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Box_Box/* default */.A, {
...
//# sourceMappingURL=3141-e99cf4b5ef920698.js.map