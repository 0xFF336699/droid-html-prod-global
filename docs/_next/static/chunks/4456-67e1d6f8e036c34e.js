"use strict";
(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[4456],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  ActionGroupContext: () => (/* reexport */ ActionGroupContext),
  ActionListContext: () => (/* reexport */ ActionListContext),
  ActionListFromEnum: () => (/* reexport */ ActionListFromEnum),
  ActionUtilsMap: () => (/* reexport */ IActionGroup/* ActionUtilsMap */.Gh),
  AllInjectKeys: () => (/* reexport */ AllInjectKeys),
  DescriptionContentRenderer: () => (/* reexport */ DescriptionContentRenderer/* DescriptionContentRenderer */.d),
  DescriptionContentType: () => (/* reexport */ IEntityDescription/* DescriptionContentType */.q),
  GroupCheckList1Context: () => (/* reexport */ GroupCheckList1Context),
  GroupCheckList2Context: () => (/* reexport */ GroupCheckList2Context),
  ISFCondfType: () => (/* reexport */ ISFCondfType),
  InjectKeyOptions: () => (/* reexport */ InjectKeyOptions),
  NodeActionKeys: () => (/* reexport */ NodeActionKeys),
  NodeActionUI: () => (/* reexport */ NodeActionUI),
  PROJECT_CATEGORY_CONFIGS: () => (/* reexport */ PROJECT_CATEGORY_CONFIGS),
  ProjectCategory: () => (/* reexport */ ProjectCategory),
  ProjectContext: () => (/* reexport */ ProjectContext),
  ProjectMemberType: () => (/* reexport */ ProjectMemberType),
  ProjectVisibility: () => (/* reexport */ IProject/* ProjectVisibility */.wg),
  RemoteSyncStatus: () => (/* reexport */ IProjectSettings/* RemoteSyncStatus */.y),
  RhinoInjectNames: () => (/* reexport */ RhinoInjectNames),
  ...
  TriggerActionContext: () => (/* reexport */ TriggerActionContext),
  TriggerActionGroupContext: () => (/* reexport */ TriggerActionGroupContext),
  TriggerContext: () => (/* reexport */ TriggerContext),
  TriggerGroupContext: () => (/* reexport */ TriggerGroupContext),
  TriggerListContext: () => (/* reexport */ TriggerListContext),
  TriggerOrActionListTypeEnum: () => (/* reexport */ TriggerOrActionListTypeEnum),
  TriggerUtilsMap: () => (/* reexport */ ITriggerGroup/* TriggerUtilsMap */.q5),
  WebViewJsInjectKeys: () => (/* reexport */ WebViewJsInjectKeys),
  ...
  actionBaseUtils: () => (/* reexport */ actionBaseUtils),
  actionGroupType: () => (/* reexport */ IActionGroup/* actionGroupType */.MI),
  actionGroupUtils: () => (/* reexport */ IActionGroup/* actionGroupUtils */.hB),
  actionType: () => (/* reexport */ actionType),
  addProjectHistory: () => (/* reexport */ addProjectHistory),
  assembleProjectScript: () => (/* reexport */ assembleProjectScript),
  assembleRhinoRunner: () => (/* reexport */ assembleRhinoRunner),
  childToProjectDataUtils: () => (/* reexport */ childToProjectDataUtils),
  createActionHandler: () => (/* reexport */ createActionHandler),
  createActionUtils: () => (/* reexport */ IActionGroup/* createActionUtils */.A5),
  createDefaultProject: () => (/* reexport */ IProject/* createDefaultProject */.Du),
  createDefaultProjectSettings: () => (/* reexport */ IProjectSettings/* createDefaultProjectSettings */.g),
  createDefaultTriggerAction: () => (/* reexport */ ITriggerAction/* createDefaultTriggerAction */.GY),
  createDefaultTriggerActionGroup: () => (/* reexport */ ITriggerActionGroup/* createDefaultTriggerActionGroup */.zA),
  createLibScript: () => (/* reexport */ createLibScript),
  createMergeToDefaultData: () => (/* reexport */ mergeToDefaultData/* createMergeToDefaultData */.dV),
  createProjectByCategory: () => (/* reexport */ IProject/* createProjectByCategory */.ZX),
  createTriggerActionUtils: () => (/* reexport */ triggerActionUtils/* createTriggerActionUtils */.i),
  createTriggerHandler: () => (/* reexport */ createTriggerHandler),
  createTriggerUtils: () => (/* reexport */ ITriggerGroup/* createTriggerUtils */.Cq),
  extractUsedTypes: () => (/* reexport */ extractUsedTypes),
  findEntityAcrossProjects: () => (/* reexport */ entityFinder/* findEntityAcrossProjects */.M),
  getActionGroupByProp: () => (/* reexport */ getActionGroupByProp),
  getActionGroupElement: () => (/* reexport */ getActionGroupElement),
  getActionGroupElementByProp: () => (/* reexport */ getActionGroupElementByProp),
  getActionListByProp: () => (/* reexport */ getActionListByProp),
  getActionUtils: () => (/* reexport */ IActionGroup/* getActionUtils */.e9),
  getAllInjectKeys: () => (/* reexport */ getAllInjectKeys),
  getInjectKeyDescription: () => (/* reexport */ getInjectKeyDescription),
  getInjectKeyDescriptionByKey: () => (/* reexport */ getInjectKeyDescriptionByKey),
  getProjectCategoryConfig: () => (/* reexport */ getProjectCategoryConfig),
  getProjectHistory: () => (/* reexport */ getProjectHistory),
  getProjectLastHistory: () => (/* reexport */ getProjectLastHistory),
  getTriggerByProp: () => (/* reexport */ getTriggerByProp),
  getTriggerElementByProp: () => (/* reexport */ getTriggerElementByProp),
  getTriggerListByProp: () => (/* reexport */ getTriggerListByProp),
  getTriggerListElementByProp: () => (/* reexport */ getTriggerListElementByProp),
  getTriggerOrActionListPageParams: () => (/* reexport */ getTriggerOrActionListPageParams),
  getTriggerUtils: () => (/* reexport */ ITriggerGroup/* getTriggerUtils */.gq),
  isSameProjectHistoryId: () => (/* reexport */ isSameProjectHistoryId),
  isValidInjectKey: () => (/* reexport */ isValidInjectKey),
  mergeDataWith: () => (/* reexport */ mergeToDefaultData/* mergeDataWith */.zI),
  mergeToDefaultData: () => (/* reexport */ mergeToDefaultData/* mergeToDefaultData */.rM),
  mergeTriggerActionGroupToDefaultData: () => (/* reexport */ ITriggerActionGroup/* mergeTriggerActionGroupToDefaultData */.Sk),
  nodeActions: () => (/* reexport */ nodeActions),
  projectDataToUniqueId: () => (/* reexport */ projectDataToUniqueId),
  projectEventUtils: () => (/* reexport */ projectEventUtils),
  projectHistoryIsChanged: () => (/* reexport */ projectHistoryIsChanged),
  projectNamespace: () => (/* reexport */ projectNamespace),
  projectStore: () => (/* reexport */ storage/* projectStore */.D),
  projectType: () => (/* reexport */ IProject/* projectType */._H),
  projectUtils: () => (/* reexport */ IProject/* projectUtils */.x3),
  projectsHistoryMap: () => (/* reexport */ projectsHistoryMap),
  registerActionUtils: () => (/* reexport */ IActionGroup/* registerActionUtils */.pX),
  registerTriggerUtils: () => (/* reexport */ ITriggerGroup/* registerTriggerUtils */.rV),
  removeProjectHistory: () => (/* reexport */ removeProjectHistory),
  s: () => (/* reexport */ storage.s),
  takeProjectSnapshoot: () => (/* reexport */ takeProjectSnapshoot),
  triggerActionGroupType: () => (/* reexport */ ITriggerActionGroup/* triggerActionGroupType */.QP),
  triggerActionType: () => (/* reexport */ ITriggerAction/* triggerActionType */.jt),
  triggerActionUtils: () => (/* reexport */ ITriggerAction/* triggerActionUtils */.q1),
  triggerBaseUtils: () => (/* reexport */ triggerBaseUtils),
  triggerGroupType: () => (/* reexport */ ITriggerGroup/* triggerGroupType */.wS),
  triggerGroupUtils: () => (/* reexport */ ITriggerGroup/* triggerGroupUtils */.zI),
  triggerType: () => (/* reexport */ triggerType),
  validateUrl: () => (/* reexport */ descriptionUtils/* validateUrl */.w)
});
 ...
 */ function createTriggerHandler(createDefaultTrigger) {
    return function onSelect(param) {
        ...
        const triggerGroup = (_projectStore_triggerGroupMap = storage/* projectStore */.D.triggerGroupMap) === null || _projectStore_triggerGroupMap === void 0 ? void 0 : _projectStore_triggerGroupMap[query.triggerGroupUlid];
        if (!triggerGroup) {
        ...
        // 4. 注册到 Store（供后续查找使用）
        storage/* projectStore */.D.triggerMap[trigger.ulid] = trigger;
        // 6. 返回编辑页面
        window.history.back();
    };
}
 ...
 */ function createActionHandler(createDefaultAction) {
    return function onSelect(param) {
        ...
        const actionGroup = (_projectStore_actionGroupMap = storage/* projectStore */.D.actionGroupMap) === null || _projectStore_actionGroupMap === void 0 ? void 0 : _projectStore_actionGroupMap[query.actionGroupUlid];
        if (!actionGroup) {
        ...
        // 4. 注册到 Store（供后续查找使用）
        storage/* projectStore */.D.actionMap[action.ulid] = action;
        // 6. 返回编辑页面
        window.history.back();
    };
}
...
const GroupCheckList2Context = /*#__PURE__*/ (0,react.createContext)([]);
...
function projectHistoryIsChanged(project) {
    const last = getProjectLastHistory(project.ulid);
    const isChanged = !last || !lodash_default().isEqual(last.project, project);
    return isChanged;
}
...
var RadioGroup = __webpack_require__(67484);
...
function NodeActionUI(param) {
    ...
    uiLog.pause = true;
    const { t } = (0,es/* useTranslation */.Bd)("droid-project-v2-interface/a11y/content");
...
;// ../../libs/droid/project-v2-interface/src/runner/projectRunner2.script.ts
/**
 * 脚本退出机制代码
 *
...
;// ../../libs/droid/project-v2-interface/src/runner/extractDependencies.ts


const extractDependencies_fileLog = new Log/* Log */.tG(false, 'extractDependencies_f');
// fileLog.pause = true;
// fileLog.childrenPaused = true;
/**
 * 从 IProject 中提取所有使用的 Trigger 和 Action 的 type
 *
 ...
 */ function extractUsedTypes(projectData) {
    extractDependencies_fileLog.log('[extractUsedTypes] 开始提取类型');
    const types = new Set();
    extractDependencies_fileLog.log('projectData=', JSON.stringify(projectData));
    // 修复：遍历 children 数组（TriggerActionGroup）
    const triggerActionGroups = projectData.children || [];
    extractDependencies_fileLog.log('[extractUsedTypes] triggerActionGroups 长度:', triggerActionGroups.length);
    for(let i = 0; i < triggerActionGroups.length; i++){
        const triggerActionGroup = triggerActionGroups[i];
        extractDependencies_fileLog.log('[extractUsedTypes] 处理 TriggerActionGroup', i, triggerActionGroup.ulid);
        // 遍历 TriggerAction
        const triggerActions = triggerActionGroup.children || [];
        extractDependencies_fileLog.log('[extractUsedTypes] triggerActions 长度:', triggerActions.length);
        for(let j = 0; j < triggerActions.length; j++){
            var _triggerAction_triggerGroup, _triggerAction_actionGroup;
            const triggerAction = triggerActions[j];
            extractDependencies_fileLog.log('[extractUsedTypes] 处理 TriggerAction', j, triggerAction.ulid);
            // 提取 Triggers
            const triggers = ((_triggerAction_triggerGroup = triggerAction.triggerGroup) === null || _triggerAction_triggerGroup === void 0 ? void 0 : _triggerAction_triggerGroup.children) || [];
            extractDependencies_fileLog.log('[extractUsedTypes] triggers 长度:', triggers.length);
            for(let k = 0; k < triggers.length; k++){
                const trigger = triggers[k];
                extractDependencies_fileLog.log('[extractUsedTypes] 处理 Trigger', k, 'type:', trigger.type);
                if (trigger.type) {
                    types.add(trigger.type);
                    extractDependencies_fileLog.log('[extractUsedTypes] 添加 Trigger type:', trigger.type);
                } else {
                    extractDependencies_fileLog.log('[extractUsedTypes] Trigger type 为空', k);
                }
            }
            // 提取 Actions
            const actions = ((_triggerAction_actionGroup = triggerAction.actionGroup) === null || _triggerAction_actionGroup === void 0 ? void 0 : _triggerAction_actionGroup.children) || [];
            extractDependencies_fileLog.log('[extractUsedTypes] actions 长度:', actions.length);
            for(let k = 0; k < actions.length; k++){
                const action = actions[k];
                extractDependencies_fileLog.log('[extractUsedTypes] 处理 Action', k, 'type:', action.type);
                if (action.type) {
                    types.add(action.type);
                    extractDependencies_fileLog.log('[extractUsedTypes] 添加 Action type:', action.type);
                } else {
                    extractDependencies_fileLog.log('[extractUsedTypes] Action type 为空', k);
                }
            }
        }
    }
    extractDependencies_fileLog.log('[extractUsedTypes] 提取完成, 总类型数:', types.size);
    extractDependencies_fileLog.log('[extractUsedTypes] 类型列表:', Array.from(types));
    return types;
}
/**
 * 递归收集依赖
 ...
 */ function prepareDependencies(dependencies) {
    ...
    extractDependencies_fileLog.log('[prepareDependencies] 处理依赖数量:', dependencies.length);
    for(let i = 0; i < dependencies.length; i++){
        const path = dependencies[i];
        extractDependencies_fileLog.log('[prepareDependencies] 处理依赖', i, 'path:', path);
        if (impSet.has(path)) {
            extractDependencies_fileLog.log('[prepareDependencies] 依赖已存在,跳过:', path);
            continue;
        }
        const file = javaLib[path];
        if (!file) {
            extractDependencies_fileLog.log('[prepareDependencies] 错误: 找不到依赖:', path);
            extractDependencies_fileLog.log('[prepareDependencies] 可用的 javaLib keys:', Object.keys(javaLib));
            throw new Error("no path in javaLib, path is ".concat(path));
        }
        extractDependencies_fileLog.log('[prepareDependencies] 添加依赖:', path);
        impSet.add(path);
        impList.push('"'.concat(path, '":').concat(file.content));
        if (file.dependencies && file.dependencies.length > 0) {
            extractDependencies_fileLog.log('[prepareDependencies] 依赖有子依赖,数量:', file.dependencies.length);
            const list = file.dependencies.map((d)=>d.path);
            prepareDependencies(list, impSet, impList);
        } else {
            extractDependencies_fileLog.log('[prepareDependencies] 依赖无子依赖');
        }
    }
    extractDependencies_fileLog.log('[prepareDependencies] 完成, 总依赖数:', impList.length);
    return impList;
}
/**
 * 创建 javaLib 对象代码
 ...
 */ function createLibScript(dependencies) {
    extractDependencies_fileLog.log('[createLibScript] 开始创建 javaLib 脚本');
    extractDependencies_fileLog.log('[createLibScript] 输入依赖数量:', dependencies.length);
    // 强制包含的核心依赖
    ...
    extractDependencies_fileLog.log('[createLibScript] 添加强制依赖 - store:', storePath);
    extractDependencies_fileLog.log('[createLibScript] 添加强制依赖 - createEventDispatcher:', createEventDispatcherPath);
    extractDependencies_fileLog.log('[createLibScript] 添加强制依赖 - createGetterSetter:', createGetterSetterPath);
    // 合并所有依赖（强制依赖 + 项目依赖）
    const allDeps = [
        storePath,
    ...
    extractDependencies_fileLog.log('[createLibScript] 总依赖数量(含强制依赖):', allDeps.length);
    extractDependencies_fileLog.log('[createLibScript] 强制依赖数量: 3 (store, createEventDispatcher, createGetterSetter)');
    extractDependencies_fileLog.log('[createLibScript] 项目依赖数量:', dependencies.length);
    const list = prepareDependencies(allDeps);
    extractDependencies_fileLog.log('[createLibScript] 收集到的代码片段数量:', list.length);
    const content = "let javaLib = {\n        ".concat(list.join(","), "\n    }");
    extractDependencies_fileLog.log('[createLibScript] javaLib 脚本创建完成');
    extractDependencies_fileLog.log('[createLibScript] 脚本长度:', content.length);
    return content;
}

;// ../../libs/droid/project-v2-interface/src/runner/assembleProjectScript.ts
 ...
 * 组装 Project 执行脚本
 *
 * 将 projectRunner2.js 引擎、javaLib 依赖和 IProject 数据组合成完整的可执行脚本
 *
 * @param projectData - Project 数据对象
 ...
 */ function assembleProjectScript(projectData) {
    ...
    assembleProjectScript_fileLog.log('[assembleProjectScript] projectData.ulid:', projectData.ulid);
...
;// ../../libs/droid/project-v2-interface/src/runner/assembleRhinoRunner.ts
 ...
 *
 * 此函数将 IProject 转换为完整的 RhinoRunner 配置,包括:
 * - 组装可执行脚本
 * - 设置权限列表
 * - 配置前台服务
 * - 设置其他运行时选项
 ...
 */ function assembleRhinoRunner(projectData, permissions, options) {
    ...
    const conf = {
        ...
        scriptId: (_ref = (_options_scriptId = options === null || options === void 0 ? void 0 : options.scriptId) !== null && _options_scriptId !== void 0 ? _options_scriptId : projectData.ulid) !== null && _ref !== void 0 ? _ref : (0,index_esm/* ulid */.Z0)(),
        script,
        // 运行时配置
...
;// ../../libs/droid/project-v2-interface/src/runner/RhinoInjectKeys.ts
/**
 * Rhino 脚本注入常量定义
 * 对应 Android 端的注入对象
 */ 
 ...
 */ async function getInjectKeyDescription(i18nKey) {
    ...
    const description = await (0,i18n_value_loader/* loadI18nValue */.y)(namespace, fullI18nKey);
...
;// ../../libs/droid/project-v2-interface/src/runner/index.ts
...
//# sourceMappingURL=4456-67e1d6f8e036c34e.js.map