...
/* harmony export */ });
/* harmony import */ var validator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17637);
...
// 图标映射
const categoryIcons = {
    [src.ProjectCategory.QuickAction]: /*#__PURE__*/ (0,jsx_runtime.jsx)(FlashOn/* default */.A, {
        sx: {
            fontSize: 48,
            color: 'primary.main'
        }
    }),
    [src.ProjectCategory.ScriptRunner]: /*#__PURE__*/ (0,jsx_runtime.jsx)(Code/* default */.A, {
        sx: {
            fontSize: 48,
            color: 'primary.main'
        }
    }),
    [src.ProjectCategory.Workflow]: /*#__PURE__*/ (0,jsx_runtime.jsx)(AccountTree/* default */.A, {
        sx: {
            fontSize: 48,
            color: 'primary.main'
        }
 ...
 */ const ProjectCategorySelectDialog = (param)=>{
    ...
    const projectCategories = [
        src.ProjectCategory.QuickAction,
        src.ProjectCategory.ScriptRunner,
        src.ProjectCategory.Workflow
    ];
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(DialogContent/* default */.A, {
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Grid2/* default */.A, {
                    ...
                    children: projectCategories.map((category, index)=>{
                        const config = src.PROJECT_CATEGORY_CONFIGS[category];
...
const CreateProjectButton = ()=>{
    ...
    const handleSelectCategory = async (category)=>{
        ...
        const project = (0,src.createProjectByCategory)(category);
        ...
        if (category === src.ProjectCategory.ScriptRunner) {
            ...
            if (!triggerAction) {
                ...
                if (actionGroup) {
                    const scriptAction = project_v2_ext_src.actionScriptUtils.createDefaultData();
        ...
        src.projectStore.addDraft(project);
        ...
        if (category === src.ProjectCategory.QuickAction) {
            path += '&isNew=true';
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Grid2/* default */.A, {
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Button_Button/* default */.A, {
                        ...
                        ...src.childToProjectDataUtils.getProjectElementsId({
                            project
...
function Projects() {
    const { t } = (0,dist_es/* useTranslation */.Bd)('droid-project/project/ui/projects/content');
    const [projects, setProjects] = (0,react.useState)(src.projectStore.getListCopy());
    (0,react.useEffect)(()=>{
        const unsub = (0,watchUpdates/* watchUpdates */.c)(src.projectStore.list, ()=>{
            setProjects(src.projectStore.getListCopy());
        });
        return ()=>{
            unsub();
        };
...
//# sourceMappingURL=6829-a9139aa549d25688.js.map