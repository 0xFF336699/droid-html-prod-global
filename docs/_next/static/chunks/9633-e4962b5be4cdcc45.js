(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[9633],{
...
/* harmony import */ var _i18n__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(69399);
...
var TextRecognitionControl_module_default = /*#__PURE__*/__webpack_require__.n(TextRecognitionControl_module);
 ...
 * 3. 监听识图事件和匹配事件
 * 4. 显示识图状态和匹配结果
 */ const TextRecognitionControl = ()=>{
    const uiLog = TextRecognitionControl_fileLog.sub(false, 'TextRecognitionControl_ui');
    const { t } = (0,dist_es/* useTranslation */.Bd)('homepage/components/screen-recognition/content');
    // 公共事件名称
    ...
    const [matchResults, setMatchResults] = (0,react.useState)([]);
    const [useRegex, setUseRegex] = (0,react.useState)(true);
    const [regexPatterns, setRegexPatterns] = (0,react.useState)('');
    const [jsFunction, setJsFunction] = (0,react.useState)('');
    const [eventName, setEventName] = (0,react.useState)('text_matched');
    const [lastMatchedText, setLastMatchedText] = (0,react.useState)('');
    const [statusMessage, setStatusMessage] = (0,react.useState)('');
    // 处理启动识图
    const handleStart = (0,react.useCallback)(()=>{
    ...
    // 检查识图状态
    const checkRunningStatus = (0,react.useCallback)(()=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
        className: (TextRecognitionControl_module_default()).textRecognitionControl,
        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
            className: (TextRecognitionControl_module_default()).controlSection,
            children: [
                /*#__PURE__*/ (0,jsx_runtime.jsx)("h2", {
                    children: t('TextRecognitionControl.title')
                }),
                /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    className: (TextRecognitionControl_module_default()).statusDisplay,
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                            className: "".concat((TextRecognitionControl_module_default()).statusIndicator, " ").concat(isRunning ? (TextRecognitionControl_module_default()).running : (TextRecognitionControl_module_default()).stopped),
                            children: [
                                isRunning ? '🟢' : '🔴',
                                " ",
                        ...
                        statusMessage && /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                            className: (TextRecognitionControl_module_default()).statusMessage,
                            children: statusMessage
                        })
                    ]
                }),
                /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    className: (TextRecognitionControl_module_default()).configSection,
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)("h3", {
                            children: t('TextRecognitionControl.matchConfig')
                        }),
                        /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                            className: (TextRecognitionControl_module_default()).configType,
                            children: [
                        ...
                        useRegex && /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                            className: (TextRecognitionControl_module_default()).regexConfig,
                            children: [
                                ...
                                /*#__PURE__*/ (0,jsx_runtime.jsx)("textarea", {
                                    value: regexPatterns,
                                    className: (TextRecognitionControl_module_default()).inputField,
                        ...
                        !useRegex && /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                            className: (TextRecognitionControl_module_default()).jsConfig,
                            children: [
                                /*#__PURE__*/ (0,jsx_runtime.jsx)("label", {
                        ...
                        /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                            className: (TextRecognitionControl_module_default()).eventNameConfig,
                            children: [
                                /*#__PURE__*/ (0,jsx_runtime.jsx)("label", {
                ...
                /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    className: (TextRecognitionControl_module_default()).buttonGroup,
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
                            onClick: handleStart,
                            disabled: isRunning,
                            className: (TextRecognitionControl_module_default()).btnStart,
                            children: t('TextRecognitionControl.startButton')
                        }),
                        /*#__PURE__*/ (0,jsx_runtime.jsx)("button", {
                            onClick: handleStop,
                            disabled: !isRunning,
                            className: (TextRecognitionControl_module_default()).btnStop,
                            children: t('TextRecognitionControl.stopButton')
                        })
                    ]
                }),
                lastMatchedText && /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    className: (TextRecognitionControl_module_default()).matchResult,
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)("h3", {
                            children: t('TextRecognitionControl.lastMatched')
                        }),
                        /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                            className: (TextRecognitionControl_module_default()).matchedText,
                            children: lastMatchedText
                        })
                    ]
                }),
                matchResults.length > 0 && /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                    className: (TextRecognitionControl_module_default()).historyResults,
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)("h3", {
                            children: t('TextRecognitionControl.matchHistory')
                        }),
                        /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                            className: (TextRecognitionControl_module_default()).resultsList,
                            children: matchResults.map((result, index)=>/*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                    className: (TextRecognitionControl_module_default()).resultItem,
                                    children: [
                                        /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                            className: (TextRecognitionControl_module_default()).resultText,
                                            children: result.matchedText
                                        }),
                                        /*#__PURE__*/ (0,jsx_runtime.jsxs)("span", {
                                            className: (TextRecognitionControl_module_default()).resultPosition,
                                            children: [
                                                "[",
                                                result.startIndex,
                                                ", ",
...
function Content() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(TextRecognitionControl, {}),
...
//# sourceMappingURL=9633-e4962b5be4cdcc45.js.map