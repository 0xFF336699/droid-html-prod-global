...
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      ...
      function () {
        return __webpack_require__(60904);
      }
    ]);
    if(false) {}
...
function AddWindow(param) {
    ...
    const handleAdd = ()=>{
        ...
        const now = Date.now();
        const finalName = name.trim() || (0,data/* generateDefaultWindowName */.aM)();
        console.log('adding new window ndroidFloatWindowData.data.windowData.windowList', data/* androidFloatWindowData */.Kl.data.windowData.windowList);
        data/* androidFloatWindowData */.Kl.data.windowData.windowList.push({
            tag: finalName,
        ...
        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Stack/* default */.A, {
            ...
            children: [
                /*#__PURE__*/ (0,jsx_runtime.jsx)(TextField/* default */.A, {
                    ...
                    placeholder: (0,data/* generateDefaultWindowName */.aM)(),
                    fullWidth: true,
                    size: "small",
                    sx: {
                        mt: '0.7rem'
...
/******/ __webpack_require__.O(0, [7054,1161,9151,3390,7313,8771,8262,3577,3622,307,636,6593,8792], () => (__webpack_exec__(33228)));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ _N_E = __webpack_exports__;
/******/ }
]);
//# sourceMappingURL=android-float-window-310aac2d8d4d9f07.js.map