...
function PhoneInput(param) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(TextField/* default */.A, {
        ...
        "data-testid": "SignUpByMobile__phoneInput__01JFQX8K9O",
        "data-test-comment": "手机号输入框，接收 11 位中国手机号"
    });
}
function VerificationCodeInput(param) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(TextField/* default */.A, {
        ...
        "data-testid": "SignUpByMobile__verificationCodeInput__01JFQX8K9P",
        "data-test-comment": "验证码输入框，接收 6 位数字验证码"
    });
}
function GetCodeButton(param) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
        ...
        disabled: disabled,
        fullWidth: true,
        "data-testid": "SignUpByMobile__getCodeButton__01JFQX8K9Q",
        "data-test-comment": "获取验证码按钮，点击后发送验证码到手机，60 秒倒计时后可重新发送",
...
function RegisterButton(param) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
        ...
        "data-testid": "SignUpByMobile__registerButton__01JFQX8K9R",
        "data-test-comment": "注册按钮，点击后提交手机号和验证码进行注册登录",
...
function SignUpByMobile() {
    ...
    const handleRegister = (0,react.useCallback)(async ()=>{
        ...
        try {
            ...
            if (user_token) {
                // user.data.storeData.user_token = user_token 
                User/* user */.k.setUserLogin(res.data);
...
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      "/sign-up-in",
      function () {
        return __webpack_require__(50000);
      }
    ]);
    if(false) {}
...
/******/ __webpack_require__.O(0, [7772,472,5241,6940,1322,2314,2214,636,6593,8792], () => (__webpack_exec__(89761)));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ _N_E = __webpack_exports__;
/******/ }
]);
//# sourceMappingURL=sign-up-in-a85ad3b1f8115682.js.map