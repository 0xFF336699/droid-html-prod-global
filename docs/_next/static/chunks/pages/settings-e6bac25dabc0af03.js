...
const fileLog = new Log/* Log */.tG(false, 'LogoutButton_f');
fileLog.pause = true;
        ...
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Box/* default */.A, {
            children: /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(ButtonConfirm/* ButtonConfirm */.b, {
                    ...
                    "data-testid": "LogoutButton__confirmDialog__01aryz6s610p4z0skjq69x5prt",
                    "data-test-comment": "退出登录确认对话框，用户点击退出按钮后弹出，需要用户确认才能执行退出",
                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
                        "data-testid": "LogoutButton__signOutButton__01aryz6s610p4z0skjq69x5pru",
                        "data-test-comment": "退出登录按钮，点击后弹出确认对话框，确认后调用 Firebase 退出接口",
...
function LogoutButtonBox() {
    ...
    fileLog.log('LogoutButtonBox userToken=', userToken);
    fileLog.log('LogoutButtonBox userToken=', User/* user */.k);
    if (!userToken) {
...
function PrivacyButton() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
            onClick: onClick,
            "data-testid": "PrivacyButton__privacyButton__01JG2B0082",
            "data-test-comment": "隐私政策按钮，点击后导航到隐私政策页面",
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/react@19.1.0/node_modules/react/index.js
var react = __webpack_require__(94285);
;// ../../libs/app/model/src/user/useUserName.tsx
...
function useUserName() {
    ...
    const [globalInfo] = (0,useProxyWatch/* useProxyWatch */.x)(User/* user */.k, 'data.sessionData.global_user_info', User/* user */.k.data.sessionData.global_user_info);
    const [name, setName] = (0,react.useState)(User/* user */.k.userName);
    (0,react.useEffect)(()=>{
        setTimeout(()=>{
            setName(User/* user */.k.userName);
        }, 100);
    }, [
        globalInfo
    ]);
...
;// ./src/components/user/user-info-summary/UserInfoSummary.tsx




function UserInfoSummary() {
    const { t } = (0,es/* useTranslation */.Bd)('homepage/components/user/user-info-summary/content');
    const [token] = (0,useProxyWatch/* useProxyWatch */.x)(User/* user */.k, 'data.storeData.user_token', User/* user */.k.data.storeData.user_token);
    const [name] = useUserName();
    if (!name) {
        console.log('user logging ');
    }
    // 不能在Hook调用后有条件性返回，改为在JSX中处理条件渲染
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
        children: token && /*#__PURE__*/ (0,jsx_runtime.jsx)(Box/* default */.A, {
            children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Stack/* default */.A, {
                direction: "row",
                spacing: 1,
                children: name && /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(Box/* default */.A, {
                            children: t('UserInfoSummary.user')
                        }),
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(Box/* default */.A, {
                            children: name
                        })
...
function AccountRemoveButton() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
            onClick: onClick,
            "data-testid": "AccountRemoveButton__removeButton__01JFQX8K9X",
            "data-test-comment": "账户删除按钮，点击后导航到账户删除页面",
...
function GoogleLoginButton() {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
        ...
        "data-testid": "GoogleLoginButton__loginButton__01JG2B0089",
        "data-test-comment": "Google登录按钮，点击后调用Android端Google登录功能",
                ...
                /*#__PURE__*/ (0,jsx_runtime.jsx)(Box/* default */.A, {
                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(ButtonConfirm/* ButtonConfirm */.b, {
                            ...
                            onConfirm: onSignoutClick,
                            "data-testid": "SignUpInButton__signOutConfirmDialog__01aryz6s610p4z0skjq69x5prw",
                            "data-test-comment": "退出登录确认对话框，用户点击退出按钮后弹出，需要用户确认才能执行退出",
                            children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Button/* default */.A, {
                                "data-testid": "SignUpInButton__signOutButton__01aryz6s610p4z0skjq69x5prx",
                                "data-test-comment": "退出登录按钮，点击后弹出确认对话框，确认后执行退出操作",
            ...
            (env/* publicRuntimeConfig */.OT.region == env/* Region */.Tp.CN || !is_in_android/* isRealInAndroid */.nd) && /*#__PURE__*/ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)((link_default()), {
                        ...
                        "data-testid": "SignUpInButton__signUpInLink__01aryz6s610p4z0skjq69x5prv",
                        "data-test-comment": "登录/注册链接，点击后导航到登录/注册页面，支持返回链接参数",
...
var ListItemIcon = __webpack_require__(33118);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/Palette.js
var Palette = __webpack_require__(50252);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@6.4.12_@mui+material@6.4.12_@emotion+react@11.14.0_@types+react@19.1.8_re_5ewkm5t5g27pzq5tz62v6ktvti/node_modules/@mui/icons-material/esm/DarkMode.js
var DarkMode = __webpack_require__(35998);
// EXTERNAL MODULE: ../../libs/app/theme/src/index.ts + 16 modules
var src = __webpack_require__(25898);
;// ./src/components/page/settings/content/ThemeSettingsSection.tsx
...
function ThemeSettingsSection() {
    const { t } = (0,es/* useTranslation */.Bd)('homepage/components/page/settings/content/content');
    const { mode, setMode, toggleColorMode } = (0,src/* useAppTheme */.o3)();
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
        sx: {
            mt: 2,
            mb: 1
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.A, {
                ...
                children: t('ThemeSettingsSection.label.appearance')
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Paper/* default */.A, {
                ...
                children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(List/* default */.A, {
                    disablePadding: true,
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsxs)(ListItem/* default */.Ay, {
                            divider: true,
                            secondaryAction: /*#__PURE__*/ (0,jsx_runtime.jsx)(Switch/* default */.A, {
                                edge: "end",
                                checked: mode === 'dark',
                                onChange: toggleColorMode,
                                "data-testid": "ThemeSettingsSection__darkModeSwitch__01JK2WVZA1I8H5Y",
                                "data-test-comment": "深色模式开关，开启后应用深色皮肤"
                            }),
                            children: [
                                /*#__PURE__*/ (0,jsx_runtime.jsx)(ListItemIcon/* default */.A, {
                                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)(DarkMode/* default */.A, {})
                                }),
                                /*#__PURE__*/ (0,jsx_runtime.jsx)(ListItemText/* default */.A, {
                                    primary: t('ThemeSettingsSection.darkMode.primary'),
                                    secondary: mode === 'dark' ? t('ThemeSettingsSection.darkMode.opened') : t('ThemeSettingsSection.darkMode.closed')
                                })
                            ]
                        }),
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(ListItem/* default */.Ay, {
                            ...
                            secondaryAction: /*#__PURE__*/ (0,jsx_runtime.jsx)(Switch/* default */.A, {
                                ...
                                "data-testid": "ThemeSettingsSection__systemModeSwitch__01JK2WVZA2J9I6Z",
                                "data-test-comment": "跟随系统开关，开启后根据操作系统偏好自动切换主题"
                            }),
                            children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(ListItemButton/* default */.A, {
                                onClick: ()=>setMode(mode === 'system' ? 'light' : 'system'),
                                "data-testid": "ThemeSettingsSection__systemModeBtn__01JK2WVZA3K0J7A",
                                "data-test-comment": "跟随系统列表项按钮，点击可切换跟随状态",
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(ListItemIcon/* default */.A, {
                                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Palette/* default */.A, {})
                                    }),
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(ListItemText/* default */.A, {
                                        primary: t('ThemeSettingsSection.followSystem.primary'),
                                        secondary: mode === 'system' ? t('ThemeSettingsSection.followSystem.opened') : t('ThemeSettingsSection.followSystem.closed')
                                    })
                                ]
                            })
                        })
...
const SettingsContent = ()=>{
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.A, {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(ThemeSettingsSection, {}),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(UserInfoSummary, {}),
...
var Fallback = __webpack_require__(88907);
...
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      "/settings",
      function () {
        return __webpack_require__(51046);
      }
    ]);
    if(false) {}
...
/******/ __webpack_require__.O(0, [7772,472,5241,8547,8248,9815,3620,2089,636,6593,8792], () => (__webpack_exec__(71421)));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ _N_E = __webpack_exports__;
/******/ }
]);
//# sourceMappingURL=settings-e6bac25dabc0af03.js.map