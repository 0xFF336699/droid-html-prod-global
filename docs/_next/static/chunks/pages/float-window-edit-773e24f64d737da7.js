...
function EditWindowContent() {
    ...
    (0,react.useEffect)(()=>{
        ...
        // 直接使用 list 中的对象（它已经是 Proxy）
        // 如果需要确保补全属性，可以使用 Object.assign 而不是 merge 出一个新对象
        setWindowConf(windowConf);
    }, [
        windowId,
        t
    ]);
...
/******/ __webpack_require__.O(0, [7772,472,402,5241,6940,1490,1322,5409,2314,5475,4706,1508,9910,636,6593,8792], () => (__webpack_exec__(54745)));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ _N_E = __webpack_exports__;
/******/ }
]);
//# sourceMappingURL=float-window-edit-773e24f64d737da7.js.map