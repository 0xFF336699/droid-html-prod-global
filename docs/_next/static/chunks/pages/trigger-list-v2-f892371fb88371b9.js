(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[5902],{
...
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      "/trigger-list-v2",
      function () {
        return __webpack_require__(41849);
      }
    ]);
    if(false) {}
...
;// ./src/components/page/trigger-list-v2/groups/time/timeout/timeout-v2.tsx



// 创建 V2 处理器
const onSelectV2 = (0,src/* createTriggerHandler */.vB)(()=>ITriggerTimeout_inft/* triggerTimeoutUtils */.V.createDefaultData());
// 复用 V1 的 UI 配置和 i18n，但使用 V2 处理器
const timeoutTriggerItemV2 = {
    id: "timeout-trigger-item-v2-ce8c",
...
;// ./src/components/page/trigger-list-v2/groups/time/time-group-v2.ts
...
const timeGroupV2 = {
    ...
    descriptionKey: "content.description",
    items: [
        timeoutTriggerItemV2
    ]
};

;// ./src/components/page/trigger-list-v2/trigger-v2.data.ts

const triggerListGroupsV2 = [
    timeGroupV2
];
...
;// ./src/pages/trigger-list-v2/index.tsx
...
function TriggerListV2() {
    const router = (0,next_router.useRouter)();
    const { t } = (0,es/* useTranslation */.Bd)("homepage/pages/trigger-list/content");
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(AppShell/* AppShell */.G, {
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(TriggerListOrActionListUI/* TriggerListOrActionListUI */.M, {
            groups: triggerListGroupsV2,
            titleConf: {
...
/******/ __webpack_require__.O(0, [472,1172,9815,7468,636,6593,8792], () => (__webpack_exec__(27945)));
/******/ var __webpack_exports__ = __webpack_require__.O();
/******/ _N_E = __webpack_exports__;
/******/ }
]);
//# sourceMappingURL=trigger-list-v2-f892371fb88371b9.js.map