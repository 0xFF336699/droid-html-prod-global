...
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      "/project-settings",
      function () {
        return __webpack_require__(94439);
      }
    ]);
    if(false) {}
...
ProjectSettingsContext_fileLog.pause = false;
// 创建 Context
...
function ProjectSettingsProvider(param) {
    ...
    // 初始化：从URL参数获取projectUlid并加载project
    (0,react.useEffect)(()=>{
        ...
        try {
            ...
            const foundProject = src/* projectStore */.DO.findProject(projectUlid);
            ...
            const settings = src/* projectStore */.DO.getProjectSettings(projectUlid);
            ...
            // 判断是否公开
            const isPublicValue = foundProject.visibility === src/* ProjectVisibility */.wg.Public;
    ...
    async function handleSave() {
        ...
        setError(null);
        try {
            fnLog.log('[handleSave] 更新projectSettings');
            fnLog.log('[handleSave] project.ulid:', project.ulid);
            ...
            if (settings) {
                fnLog.log('[handleSave] settings 存在');
            ...
            const newVisibility = isPublic ? src/* ProjectVisibility */.wg.Public : src/* ProjectVisibility */.wg.Private;
...
DeleteConfirmDialog_fileLog.pause = false;
                                ...
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(FormControlLabel/* default */.A, {
                                        control: /*#__PURE__*/ (0,jsx_runtime.jsx)(Checkbox/* default */.A, {
                                            ...
                                            onChange: (e)=>setDeleteFromLocal(e.target.checked)
                                        }),
...
ProjectSettingsContent_fileLog.pause = false;
// 内部组件：主内容
...
/******/ __webpack_require__.O(0, [472,9669,8547,9361,4522,636,6593,8792], () => (__webpack_exec__(16717)));
