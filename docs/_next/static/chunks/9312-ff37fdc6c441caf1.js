(self["webpackChunk_N_E"] = self["webpackChunk_N_E"] || []).push([[9312],{
...
var src = __webpack_require__(3200);
// EXTERNAL MODULE: ../../libs/fanfanlo/dist/src/watcher/proxyWatch.js + 2 modules
...
var project_v2_interface_src = __webpack_require__(76094);
...
// EXTERNAL MODULE: ../../libs/droid/project-v2-ext/src/index.ts + 54 modules
var project_v2_ext_src = __webpack_require__(41654);
...
// 图标映射
const categoryIcons = {
    [project_v2_interface_src/* ProjectCategory */.U2.QuickAction]: /*#__PURE__*/ (0,jsx_runtime.jsx)(FlashOn/* default */.A, {
        sx: {
            fontSize: 48,
            color: 'primary.main'
        }
    }),
    [project_v2_interface_src/* ProjectCategory */.U2.ScriptRunner]: /*#__PURE__*/ (0,jsx_runtime.jsx)(Code/* default */.A, {
        sx: {
            fontSize: 48,
            color: 'primary.main'
        }
    }),
    [project_v2_interface_src/* ProjectCategory */.U2.Workflow]: /*#__PURE__*/ (0,jsx_runtime.jsx)(AccountTree/* default */.A, {
        sx: {
            fontSize: 48,
            color: 'primary.main'
        }
 ...
 */ const ProjectCategorySelectDialog = (param)=>{
    ...
    const projectCategories = [
        project_v2_interface_src/* ProjectCategory */.U2.QuickAction,
        project_v2_interface_src/* ProjectCategory */.U2.ScriptRunner,
        project_v2_interface_src/* ProjectCategory */.U2.Workflow
    ];
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(DialogContent/* default */.A, {
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Grid2/* default */.A, {
                    ...
                    children: projectCategories.map((category, index)=>{
                        const config = project_v2_interface_src/* PROJECT_CATEGORY_CONFIGS */.v8[category];
...
const CreateProjectButton = ()=>{
    ...
    const handleSelectCategory = async (category)=>{
        ...
        const project = (0,project_v2_interface_src/* createProjectByCategory */.ZX)(category);
        ...
        if (category === project_v2_interface_src/* ProjectCategory */.U2.ScriptRunner) {
        ...
        project_v2_interface_src/* projectStore */.DO.addDraft(project);
        ...
        if (category === project_v2_interface_src/* ProjectCategory */.U2.QuickAction) {
            path += '&isNew=true';
...
function DeleteProjectButton() {
    const { t } = (0,dist_es/* useTranslation */.Bd)("droid-project-v2-ui/ui/components/content");
    const project = (0,react.useContext)(project_v2_interface_src/* ProjectContext */.vz);
    const projectUlid = project.ulid;
    const handleDelete = ()=>{
        project_v2_interface_src/* projectStore */.DO.removeProject(projectUlid);
    };
...
function ProjectName(param) {
    ...
    console.log('ffffffffffffffffff', t('content.project.settings'));
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Grid2/* default */.A, {
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Button_Button/* default */.A, {
                        ...
                        ...project_v2_interface_src/* childToProjectDataUtils */.mR.getProjectElementsId({
                            project
...
function ProjectUI(param) {
    let { project } = param;
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(project_v2_interface_src/* ProjectContext */.vz.Provider, {
        value: project,
...
function Projects() {
    const { t } = (0,dist_es/* useTranslation */.Bd)('droid-project/project/ui/projects/content');
    const [projects, setProjects] = (0,react.useState)(project_v2_interface_src/* projectStore */.DO.getListCopy());
    (0,react.useEffect)(()=>{
        const unsub = (0,watchUpdates/* watchUpdates */.c)(project_v2_interface_src/* projectStore */.DO.list, ()=>{
            setProjects(project_v2_interface_src/* projectStore */.DO.getListCopy());
        });
        return ()=>{
            unsub();
        };
...
const components_ProjectCategorySelectDialog_fileLog = new Log/* Log */.tG(true, 'ProjectCategorySelectDialog');
components_ProjectCategorySelectDialog_fileLog.pause = true;
components_ProjectCategorySelectDialog_fileLog.childrenPaused = true;
// 图标映射
const ProjectCategorySelectDialog_categoryIcons = {
...
/**
 * 项目类别选择对话框
 */ const ProjectCategorySelectDialog_ProjectCategorySelectDialog = (param)=>{
    let { open, onClose, onSelect } = param;
    const { t } = (0,dist_es/* useTranslation */.Bd)("droid-project/project/ui/components/content");
    components_ProjectCategorySelectDialog_fileLog.log("[ProjectCategorySelectDialog] 渲染, open=".concat(open));
    const projectCategories = [
    ...
    const handleSelect = (category)=>{
        components_ProjectCategorySelectDialog_fileLog.log("[ProjectCategorySelectDialog] 选择类别: ".concat(category));
        onSelect(category);
    };
    const handleClose = ()=>{
        components_ProjectCategorySelectDialog_fileLog.log("[ProjectCategorySelectDialog] 关闭对话框");
        onClose();
    };
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Dialog/* default */.A, {
        open: open,
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(DialogContent/* default */.A, {
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Grid2/* default */.A, {
                    ...
                    children: projectCategories.map((category)=>{
                        ...
                        components_ProjectCategorySelectDialog_fileLog.log("[ProjectCategorySelectDialog] 渲染类别卡片: ".concat(category, ", config="), JSON.stringify(config));
                        return /*#__PURE__*/ (0,jsx_runtime.jsx)(Grid2/* default */.A, {
                            size: {
                                xs: 12,
                                sm: 4
                            ...
                            children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Card/* default */.A, {
                                ...
                                "data-testid": "project-category-".concat(category),
                                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(CardActionArea/* default */.A, {
                                    onClick: ()=>handleSelect(category),
                                    sx: {
                                        height: '100%',
                                    ...
                                    children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(CardContent/* default */.A, {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Box_Box/* default */.A, {
                                                ...
                                                children: ProjectCategorySelectDialog_categoryIcons[category]
                                            }),
                                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.A, {
                                                variant: "h6",
                                                gutterBottom: true,
...
const components_CreateProjectButton_fileLog = new Log/* Log */.tG(true, 'CreateProjectButton');
components_CreateProjectButton_fileLog.pause = true;
components_CreateProjectButton_fileLog.childrenPaused = true;
const CreateProjectButton_CreateProjectButton = ()=>{
    const { t } = (0,dist_es/* useTranslation */.Bd)("droid-project/project/ui/components/content");
    const router = (0,next_router.useRouter)();
    const [dialogOpen, setDialogOpen] = (0,react.useState)(false);
    components_CreateProjectButton_fileLog.log("[CreateProjectButton] 渲染, dialogOpen=".concat(dialogOpen));
    const handleOpenDialog = ()=>{
        components_CreateProjectButton_fileLog.log("[CreateProjectButton] 打开类别选择对话框");
        setDialogOpen(true);
    };
    const handleCloseDialog = ()=>{
        components_CreateProjectButton_fileLog.log("[CreateProjectButton] 关闭类别选择对话框");
        setDialogOpen(false);
    };
    const handleSelectCategory = async (category)=>{
        components_CreateProjectButton_fileLog.log("[CreateProjectButton] 用户选择类别: ".concat(category));
        const project = (0,IProject_data/* createProjectByCategory */.ZX)(category);
        components_CreateProjectButton_fileLog.log("[CreateProjectButton] 创建 project, client_id=".concat(project.client_id, ", category=").concat(project.category));
        // 如果是 ScriptRunner，添加一个 script action
        if (category === ProjectCategory/* ProjectCategory */.U2.ScriptRunner) {
            components_CreateProjectButton_fileLog.log("[CreateProjectButton] ScriptRunner: 添加 script action");
            const actionGroup = project.triggerActionGroup.list[0].actionGroup;
            components_CreateProjectButton_fileLog.log("[CreateProjectButton] actionGroup.list.length before: ".concat(actionGroup.list.length));
            const scriptAction = IActionScript_inft/* actionScriptUtils */.x.createDefaultData();
            components_CreateProjectButton_fileLog.log("[CreateProjectButton] 创建 scriptAction:", JSON.stringify(scriptAction));
            actionGroup.list.push(scriptAction);
            components_CreateProjectButton_fileLog.log("[CreateProjectButton] actionGroup.list.length after: ".concat(actionGroup.list.length));
        }
        storage/* projectStore */.D.addDraft(project);
        components_CreateProjectButton_fileLog.log("[CreateProjectButton] project 已添加到 draft store");
        // 构建跳转路径
        let path = "/project-editor?client_id=".concat(project.client_id);
        // 如果是 QuickAction，添加 isNew 参数，用于在编辑器中判断是否需要跳转到 action-list
        if (category === ProjectCategory/* ProjectCategory */.U2.QuickAction) {
            path += '&isNew=true';
            components_CreateProjectButton_fileLog.log("[CreateProjectButton] QuickAction: 添加 isNew 参数");
        }
        components_CreateProjectButton_fileLog.log("[CreateProjectButton] 准备跳转到: ".concat(path));
        await router.prefetch(path);
        router.push(path);
        setDialogOpen(false);
    };
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)("span", {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(ProjectCategorySelectDialog_ProjectCategorySelectDialog, {
                open: dialogOpen,
                onClose: handleCloseDialog,
                onSelect: handleSelectCategory
            })
...
var project_contexts = __webpack_require__(26944);
;// ../../libs/droid/project/src/project/utils/projectUtils.ts
const projectUtils_projectUtils = {
    getProjectName: (project)=>{
        return (project === null || project === void 0 ? void 0 : project.localName) || (project === null || project === void 0 ? void 0 : project.name) || (project === null || project === void 0 ? void 0 : project.client_id.slice((project === null || project === void 0 ? void 0 : project.client_id.length) - 8)) || '';
    }
};

// EXTERNAL MODULE: ../../libs/droid/project/src/project/utils/runProject.ts + 1 modules
var utils_runProject = __webpack_require__(8136);
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(ButtonConfirm/* ButtonConfirm */.b, {
            ...
            children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Button_Button/* default */.A, {
                id: "project-simple-title-list-del-btn",
                "data-id": "project-simple-title-list-del-btn",
                "data-testid": "DeleteProjectButton__deleteButton__01JG2B0094",
                "data-test-comment": "删除项目按钮，点击后弹出确认对话框，确认后删除项目",
                children: t('content.delete')
            })
        })
...
const project_ProjectUI_fileLog = new Log/* Log */.tG(false, 'ProjectUI_f');
project_ProjectUI_fileLog.pause = true;
project_ProjectUI_fileLog.childrenPaused = true;
function ProjectUI_ProjectName(param) {
    let { project } = param;
    const router = (0,next_router.useRouter)();
    const { t } = (0,dist_es/* useTranslation */.Bd)('droid-project/project/ui/project/content');
    const [isRunning, setIsRunning] = (0,react.useState)(false);
    (0,react.useEffect)(()=>{
        const fnLog = project_ProjectUI_fileLog.sub(false, 'ProjectName_useEffect_fn');
        fnLog.log('[ProjectName] useEffect 初始化');
        fnLog.log('[ProjectName] project.client_id:', project.client_id);
        const projectClientId = project.client_id;
        const hasProjectClientId = projectClientId ? true : false;
        fnLog.log('[ProjectName] 是否有projectClientId:', hasProjectClientId);
        if (!hasProjectClientId) {
            fnLog.log('[ProjectName] projectClientId为空,跳过初始化');
            return;
        }
        try {
            fnLog.log('[ProjectName] 调用 RhinoManager.isRunning 检查初始状态');
            const script = '\n            com.fanfanlo.droidlib.auto.rhino.RhinoManager.isRunning("'.concat(projectClientId, '")\n            ');
            const { javaResultString } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
            fnLog.log('[ProjectName] RhinoManager.isRunning 返回:', javaResultString);
            const isRunning = (javaResultString === null || javaResultString === void 0 ? void 0 : javaResultString.toString()) == 'true';
            fnLog.log('[ProjectName] 初始运行状态:', isRunning);
        ...
        const eventNameOn = "project_".concat(projectClientId, "_running_on");
        const eventNameOff = "project_".concat(projectClientId, "_running_off");
        fnLog.log('[ProjectName] 监听on事件:', eventNameOn);
        fnLog.log('[ProjectName] 监听off事件:', eventNameOff);
        const handleRunningOn = (event)=>{
            fnLog.log('[ProjectName] 收到running_on事件');
    ...
    async function onRunClick() {
        const fnLog = project_ProjectUI_fileLog.sub(false, 'onRunClick_fn');
        fnLog.log('[onRunClick] 开始运行项目');
        fnLog.log('[onRunClick] project.client_id:', project.client_id);
        fnLog.log('[onRunClick] project.name:', project.name);
        try {
            const result = await (0,utils_runProject/* runProject */.t)(project);
            fnLog.log('[onRunClick] runProject 返回结果:', result);
        } catch (error) {
            fnLog.log('[onRunClick] runProject 执行异常:', error);
        }
    ...
    async function onStopClick() {
        const fnLog = project_ProjectUI_fileLog.sub(false, 'onStopClick_fn');
        fnLog.log('[onStopClick] 开始停止项目');
        fnLog.log('[onStopClick] project.client_id:', project.client_id);
        const projectClientId = project.client_id;
        const hasProjectClientId = projectClientId ? true : false;
        fnLog.log('[onStopClick] 是否有projectClientId:', hasProjectClientId);
        if (!hasProjectClientId) {
            fnLog.log('[onStopClick] projectClientId为空,无法停止');
            return;
        }
        try {
            const script = '\n            com.fanfanlo.droidlib.auto.rhino.JsRhinoManager.jsCallStopById("'.concat(projectClientId, '")\n            ');
            fnLog.log('[onStopClick] 调用stopById脚本', script);
            const { javaResultString } = AutoWebViewJs/* autoWebViewJs */.yx.callScript(script);
            fnLog.log('[onStopClick] RhinoManager.stopById 返回结果:', javaResultString);
        } catch (error) {
    ...
    async function onToggleRunClick() {
        const fnLog = project_ProjectUI_fileLog.sub(false, 'onToggleRunClick_fn');
        fnLog.log('[onToggleRunClick] 切换运行状态');
        fnLog.log('[onToggleRunClick] 当前isRunning:', isRunning);
        const currentIsRunning = isRunning;
        fnLog.log('[onToggleRunClick] currentIsRunning值:', currentIsRunning);
    ...
    function edit() {
        const path = "/project-editor?client_id=".concat(project.client_id);
        router.push(path, undefined, {
            shallow: true
        });
    }
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Grid2/* default */.A, {
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Grid2/* default */.A, {
                size: "grow",
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                    children: projectUtils_projectUtils.getProjectName(project)
                })
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Grid2/* default */.A, {
                container: true,
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Button_Button/* default */.A, {
                        ...
                        "data-listof-project-list-btn-id": project.client_id,
                        id: "project-simple-title-list-toggle-btn",
                        "data-id": "project-simple-title-list-toggle-btn",
                        onClick: onToggleRunClick,
                        color: isRunning ? "error" : "primary",
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Button_Button/* default */.A, {
                        ...
                        "data-listof-project-list-edit-btn-id": project.client_id,
                        id: "project-simple-title-list-edit-btn",
                        "data-id": "project-simple-title-list-edit-btn",
                        onClick: edit,
                        children: t('content.project.edit')
                    }),
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(DeleteProjectButton_DeleteProjectButton, {})
                ]
            })
        ]
    });
}
function ProjectUI_ProjectUI(param) {
    let { project } = param;
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(project_contexts/* ProjectContext */.vz.Provider, {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Box_Box/* default */.A, {
            ...
            children: /*#__PURE__*/ (0,jsx_runtime.jsx)(ProjectUI_ProjectName, {
                project: project
            })
        })
    });
...
function ProjectsInfoItemUI_ProjectsTitle() {
    const { t } = (0,dist_es/* useTranslation */.Bd)('droid-project/project/ui/projects/content');
    // const v = use(loadI18nValue('droid-project/project/ui/projects/content', 'content.projects'))
    // console.log('ttttttttttttttttttttttt', v, 'tttt', t)
    return /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
...
function ProjectsInfoItemUI_ProjectList(param) {
    let { projects } = param;
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(List/* default */.A, {
        sx: {
            width: "100%"
        ...
        children: projects.length > 0 && projects.map((project)=>/*#__PURE__*/ (0,jsx_runtime.jsx)(ListItem/* default */.Ay, {
                ...
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(ProjectUI_ProjectUI, {
                    project: project
                }, project.client_id)
            }, project.client_id))
    });
}
function ProjectsInfoItemUI_Projects() {
    const { t } = (0,dist_es/* useTranslation */.Bd)('droid-project/project/ui/projects/content');
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box_Box/* default */.A, {
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)(CreateProjectButton_CreateProjectButton, {}),
            projects.length == 0 && /*#__PURE__*/ (0,jsx_runtime.jsx)(Box_Box/* default */.A, {
                children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box_Box/* default */.A, {
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
            ...
            projects.length > 0 && /*#__PURE__*/ (0,jsx_runtime.jsx)(ProjectsInfoItemUI_ProjectList, {
                projects: projects
            })
        ]
    });
}
function projects_ProjectsInfoItemUI_ProjectsUI() {
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box_Box/* default */.A, {
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)(ProjectsInfoItemUI_ProjectsTitle, {}),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(ProjectsInfoItemUI_Projects, {})
        ]
    });
}
...
function HomeGlobalProdContent() {
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box_Box/* default */.A, {
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(projects_ProjectsInfoItemUI_ProjectsUI, {})
        ]
    });
}
...
var store_page_context = __webpack_require__(47630);
// EXTERNAL MODULE: ../../node_modules/.pnpm/next@15.3.5_@babel+core@7.28.0_@playwright+test@1.57.0_babel-plugin-macros@3.1.0_react-dom@19_gjfccjsd7b6xv5ktyj7vxamu6q/node_modules/next/router.js
var next_router = __webpack_require__(1674);
...
/* harmony export */ });
/* harmony import */ var _droid_android__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(68709);
/* harmony import */ var _droid_project_v2_ext__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(41654);
/* harmony import */ var _fanfanlo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(89597);
/* harmony import */ var _app_static__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(92289);
/* harmony import */ var _app_static__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(52198);
/* harmony import */ var _app_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(80530);





const fileLog = new _fanfanlo__WEBPACK_IMPORTED_MODULE_1__/* .Log */ .tG(false, 'runProject_f');
// fileLog.pause = true;  // 注释掉：允许日志输出
// fileLog.childrenPaused = true;  // 注释掉：允许子日志输出
/**
 * 运行项目
 ...
 */ async function runProject(projectData) {
    ...
    // fnLog.pause = true;  // 注释掉：允许日志输出
    // fnLog.childrenPaused = true;  // 注释掉：允许子日志输出
    ...
    const removedCount = _droid_project_v2_ext__WEBPACK_IMPORTED_MODULE_0__/* .projectUtils */ .x3.cleanEmptyTriggerActions(projectData);
    ...
    try {
        ...
        const permissions = await _droid_project_v2_ext__WEBPACK_IMPORTED_MODULE_0__/* .projectUtils */ .x3.getProjectPermissionsData(projectData);
        fnLog.log('[runProject] 权限数量:', permissions.length);
        // 2. 获取项目所需的注入配置
        fnLog.log('[runProject] 获取注入配置', JSON.stringify(projectData));
        const projectInjects = _droid_project_v2_ext__WEBPACK_IMPORTED_MODULE_0__/* .projectUtils */ .x3.getProjectInjects(projectData);
        ...
        const finalInjects = [
            [
                _app_static__WEBPACK_IMPORTED_MODULE_2__/* .WebViewJsInjectKeys */ .Ik.console,
                'console'
            ]
        ];
        ...
        const conf = (0,_app_static__WEBPACK_IMPORTED_MODULE_3__/* .assembleRhinoRunner */ .n)(projectData, permissions, {
        ...
        const userId = _app_model__WEBPACK_IMPORTED_MODULE_4__/* .user */ .k.data.storeData.user_token || '';
        ...
        const result = await _droid_android__WEBPACK_IMPORTED_MODULE_5__/* .autoWebViewJs */ .yx.runProject(conf, userId, projectName, projectUlid);
...
//# sourceMappingURL=9312-ff37fdc6c441caf1.js.map